...
<div class="page-container">
	...
	<div class="main-content">
		...
		<h2 class="header" onclick="location.reload();">금융계산기 (예금 설계)</h2>
		<br/>
				...
				<div class="right flex-column flex-100">
                    <div class="right-top">
                        <ul class="nav">
                            ...
                            <li class="nav-tab active" @click="tabChange('PT02')">예금 설계</li>
...
var vueapp = new Vue({
	...
	methods : {
		...
		prcCalc : function(){
			...
			var nPymAmt		= Math.round(this.info.circle_acml_amt); // 예치금액
			var nPrd		= Math.round(this.info.goal_prd/12); // 예치기간
			var nApplItr	= Math.round(this.info.aply_rate); // 적용금리
				nApplItr	= nApplItr / 100;
